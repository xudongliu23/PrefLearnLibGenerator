...
original_class_data_downsampled_n="discrete_credit_approval_downsampled_n.csv"
original_class_data_downsampled_sorted_n="discrete_credit_approval_downsampled_sorted_n.csv"
original_class_data_downsampled_sorted="discrete_credit_approval_downsampled_sorted.csv"
original_class_data_downsampled_sorted_uniq="discrete_credit_approval_downsampled_sorted_uniq.csv"
original_class_data_downsampled_sorted_dup="discrete_credit_approval_downsampled_sorted_dup.csv"
original_class_data_downsampled_sorted_uniq_real="discrete_credit_approval_downsampled_sorted_uniq_real.csv"
original_class_data_downsampled="discrete_credit_approval_downsampled.csv"
awk_sh="rm_dup.awk"
...
sed -i 's/,+/;+/g' $original_class_data_downsampled_sorted_uniq
sed -i 's/,-/;-/g' $original_class_data_downsampled_sorted_uniq
...
sed -i 's/;+/,+/g' $original_class_data_downsampled
sed -i 's/;-/,-/g' $original_class_data_downsampled
