...
original_class_data_downsampled_further_n="discrete_german_credit_downsampled_further_n.csv"
original_class_data_downsampled_further_sorted_n="discrete_german_credit_downsampled_further_sorted_n.csv"
original_class_data_downsampled_further_sorted="discrete_german_credit_downsampled_further_sorted.csv"
original_class_data_downsampled_further_sorted_uniq="discrete_german_credit_downsampled_further_sorted_uniq.csv"
original_class_data_downsampled_further_sorted_dup="discrete_german_credit_downsampled_further_sorted_dup.csv"
original_class_data_downsampled_further_sorted_uniq_real="discrete_german_credit_downsampled_further_sorted_uniq_real.csv"
original_class_data_downsampled_further="discrete_german_credit_downsampled_further.csv"
awk_sh="rm_dup.awk"
...
sed -i 's/,1$/;good/g' $original_class_data_downsampled_further_sorted_uniq
sed -i 's/,2$/;bad/g' $original_class_data_downsampled_further_sorted_uniq
...
sed -i 's/;good$/,1/g' $original_class_data_downsampled_further
sed -i 's/;bad$/,2/g' $original_class_data_downsampled_further
