...
original_class_data_downsampled_further_n="discrete_vehicle_downsampled_further_n.csv"
original_class_data_downsampled_further_sorted_n="discrete_vehicle_downsampled_further_sorted_n.csv"
original_class_data_downsampled_further_sorted="discrete_vehicle_downsampled_further_sorted.csv"
original_class_data_downsampled_further_sorted_uniq="discrete_vehicle_downsampled_further_sorted_uniq.csv"
original_class_data_downsampled_further_sorted_dup="discrete_vehicle_downsampled_further_sorted_dup.csv"
original_class_data_downsampled_further_sorted_uniq_real="discrete_vehicle_downsampled_further_sorted_uniq_real.csv"
original_class_data_downsampled_further="discrete_vehicle_downsampled_further.csv"
awk_sh="rm_dup.awk"
...
sed -i 's/,bus$/;bus/g' $original_class_data_downsampled_further_sorted_uniq
sed -i 's/,opel$/;opel/g' $original_class_data_downsampled_further_sorted_uniq
sed -i 's/,saab$/;saab/g' $original_class_data_downsampled_further_sorted_uniq
sed -i 's/,van$/;van/g' $original_class_data_downsampled_further_sorted_uniq
...
sed -i 's/;bus$/,bus/g' $original_class_data_downsampled_further
sed -i 's/;opel$/,opel/g' $original_class_data_downsampled_further
sed -i 's/;saab$/,saab/g' $original_class_data_downsampled_further
sed -i 's/;van$/,van/g' $original_class_data_downsampled_further
