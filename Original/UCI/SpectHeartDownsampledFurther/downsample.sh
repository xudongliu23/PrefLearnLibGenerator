...
original_class_data_nolabels_n_downsampled_further="spect_heart_nolabels_n_downsampled_further.csv"
original_class_data_downsampled_further_n="spect_heart_downsampled_further_n.csv"
original_class_data_downsampled_further_sorted_n="spect_heart_downsampled_further_sorted_n.csv"
original_class_data_downsampled_further_sorted="spect_heart_downsampled_further_sorted.csv"
original_class_data_downsampled_further_sorted_uniq="spect_heart_downsampled_further_sorted_uniq.csv"
original_class_data_downsampled_further_sorted_dup="spect_heart_downsampled_further_sorted_dup.csv"
original_class_data_downsampled_further_sorted_uniq_real="spect_heart_downsampled_further_sorted_uniq_real.csv"
original_class_data_downsampled_further="spect_heart_downsampled_further.csv"
awk_sh="rm_dup.awk"
...
sed -i 's/,normal$/;normal/g' $original_class_data_downsampled_further_sorted_uniq
sed -i 's/,abnormal$/;abnormal/g' $original_class_data_downsampled_further_sorted_uniq
...
sed -i 's/;normal$/,0/g' $original_class_data_downsampled_further
sed -i 's/;abnormal$/,1/g' $original_class_data_downsampled_further
